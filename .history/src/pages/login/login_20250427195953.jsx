	...
	return (
		<div className={styles.page} >
			...
			<form  onSubmit={handleSubmit} className={styles.form}>
                <EmailInput onChange={handleChange} value={email} name="email" extraClass="mb-6" />
                <PasswordInput onChange={handleChange} value="{password" extraClass="mb-6" name='password'/>
