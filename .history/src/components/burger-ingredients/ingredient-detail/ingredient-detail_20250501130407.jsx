...
export const IngredientDetail = () => {
    ...
    const {ingredientsList, ingredientsSuccessFetching} = useSelector(state => state.ingredients.ingridientList)


	const selectedIngredient = ingredient ?? ingredientsList?.find((item) => item._id === id);
    ...
    }, [ingridientsFetching, showModal, ingridientsFailedFetching, ingredientsList, selectedIngredient])
