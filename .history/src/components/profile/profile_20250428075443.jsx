    ...
    return (
        <form method="POST" onSubmit={handleSubmit}>
            <div className="mb-6">
				...
				value={form?.name||''}  autocomplete="on"
				/>
            </div>
            <div className="mb-6">
                <EmailInput isIcon={true} value={form?.email||""} onChange={handleChange} />
            </div>
            <div className="mb-6">
                <PasswordInput value={form.password} onChange={handleChange} autocomplete="on"/>
            </div>
            {!isLoading &&
