    ...
    return (
        <form method="POST" onSubmit={handleSubmit}>
            <div className="mb-6">
                ...
                ref={inputRef}
				onIconClick={onIconClick} value={nameValue}/>
            </div>
            <div className="mb-6">
                <EmailInput isIcon={true} value={emailValue} onChange={handleChange} />
            </div>
            <div className="mb-6">
                <PasswordInput icon={"EditIcon"} value={passwordValue} onChange={handleChange} />
            </div>
            {isChanged &&
